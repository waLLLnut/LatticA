#ifndef NTT16BIT_ARMV8_2_A_NEON_H
#define NTT16BIT_ARMV8_2_A_NEON_H
...
extern void C_asm_mul0_mont_15bit_neon(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO);
extern void C_asm_mul1_mont_15bit_neon(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO);
extern void C_asm_mul2_mont_15bit_neon(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO);
extern void C_asm_mul3_mont_15bit_neon(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO);
...
extern void asm_decom_mont_qnum2_base8_rm8_len3_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim);
extern void asm_decom_mont_qnum2_base9_rm10_len2_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim);
extern void asm_decom_mont_qnum2_base11_rm17_len1_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim);


void C_asm_decom_mont_qnum2_base8_rm8_len3_16bit_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim, int Ks);
void C_asm_decom_mont_qnum2_base9_rm10_len2_16bit_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim, int Ks);
void C_asm_decom_mont_qnum2_base11_rm17_len1_16bit_neon(int16_t *from, int16_t * to, const int32_t *INFO, const int16_t *GADGET, int dim, int Ks);
...
extern void asm_ntt0_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,   int32_t* y, const int32_t* INFO);
extern void asm_ntt1_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_ntt2_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_ntt3_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_ntt4_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);

extern void asm_intt0_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_intt1_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_intt2_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_intt3_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_intt4_to_mont_31bit_1024_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
...
extern void asm_mul0_mont_31bit_1024_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul1_mont_31bit_1024_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul2_mont_31bit_1024_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul3_mont_31bit_1024_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);



extern void asm_ntt0_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_ntt1_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,  int32_t *y, const int32_t* INFO);
extern void asm_ntt2_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,    int32_t *y, const int32_t* INFO);
extern void asm_ntt3_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,    int32_t *y, const int32_t* INFO);
extern void asm_ntt4_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,    int32_t *y, const int32_t* INFO);


extern void asm_intt0_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_intt1_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_intt2_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);
extern void asm_intt3_to_mont_31bit_512_neon(const int32_t *NTTINFO, int32_t * x,   int32_t *y, const int32_t* INFO);




extern void asm_mul0_mont_31bit_512_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul1_mont_31bit_512_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul2_mont_31bit_512_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
extern void asm_mul3_mont_31bit_512_neon(int32_t *res, int32_t * x, int32_t *y, const int32_t *MULINFO, const int32_t* INFO);
...
/**************************** TEST Reduction ****************************/
extern void asm_signed_montgo_16bit_NEON(int16_t *x,	int16_t *y, int16_t *res,		int16_t *q, int16_t *mont);
extern void asm_signed_montgo_Negative_16bit_NEON(int16_t *x,	int16_t *y, int16_t *res,		int16_t *q, int16_t *mont);

extern void asm_signed_shoup_16bit_NEON(int16_t *x,	int16_t *y, int16_t *res,	int16_t *q, int16_t *y_prime);
extern void asm_signed_shoup_Negative_16bit_NEON(int16_t *x,	int16_t *y, int16_t *res,	int16_t *q, int16_t *y_prime);
