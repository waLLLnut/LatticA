...
/******************************** VECMATMUL ******************************************/
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_8_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_7_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_6_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_5_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_4_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_3_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
void C_asm_mul0_mont_VecMat_DEPTH0_14bit_2_avx2(int16_t *res, int16_t * x, int16_t *y, const int16_t *MULINFO, const int32_t* INFO, int out_len, int in_len);
