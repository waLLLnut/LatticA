    ...
    */
    ...
    class Poly32 {
        ...
        public:
            ...
            int32_t GetN() const { return _Param_NTT->GetN();};
            int32_t GetQ(int idx) const { return _Param_NTT->GetQ(idx);};
            int32_t GetQnum() const { return _Param_NTT->GetQnum();};
    ...
    class Poly16 {
        ...
        public:
            ...
            int16_t GetN() const { return _Param_NTT->GetN();};
            int16_t GetQ(int idx) const { return _Param_NTT->GetQ(idx);};
            int16_t GetQnum() const { return _Param_NTT->GetQnum();};
